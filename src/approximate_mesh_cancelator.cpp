...
void ApproximateMeshCancelator::set_strides()
{
...
void ApproximateMeshCancelator::perform_cancellation_full_vector(pcg32& /*rng*/) {
  // Get keys of all non empty bins
...
void ApproximateMeshCancelator::perform_cancellation(pcg32& rng) {
  this->perform_cancellation_full_vector(rng);
}
